...
var AppointmentConfirmationComponent = /** @class */ (function () {
    function AppointmentConfirmationComponent(_session) {
        var _this = this;
        ...
        this._session.select(_core_services_session_service__WEBPACK_IMPORTED_MODULE_1__["SESSION_KEY"].DOCTOR_LIST).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function (data) {
            _this.hasBanner = data.newAppointmentBanner;
        });
        if (this.hasBanner) {
    ...
    AppointmentConfirmationComponent.ctorParameters = function () { return [
...
var BookAppointmentComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](BookAppointmentComponent, _super);
    function BookAppointmentComponent(_fb, _session, _calendar, _api, _route, _router) {
        ...
        _this.formName = 'appointmentForm';
        _this.appointmentForm = _this._fb.group({
        ...
        _this.minDate = _this._calendar.getToday();
        _this.maxDate = _this._calendar.getNext(_this.minDate, 'd', 30);
        _this.specialityTypes = [];
        _this.doctorLists = {};
        _this.bookedTimeSlots = {};
        _this.timeSlots = _core_model_doctor_list__WEBPACK_IMPORTED_MODULE_1__["TIME_SLOTS"];
        _this.error = false;
        _this.isCounsellor = false;
        _this.isDisabled = function (date) {
            var dateFormat = _this.formatDate(date);
            if (lodash__WEBPACK_IMPORTED_MODULE_8__["has"](_this.doctorTimeSlot, dateFormat)) {
                return _this.doctorTimeSlot[dateFormat].length === 4;
            }
            return false;
        };
        _this._sessionSub$ = _this._session.select(_core_services_session_service__WEBPACK_IMPORTED_MODULE_3__["SESSION_KEY"].DOCTOR_LIST).subscribe(function (data) {
            _this.specialityTypes = data.specialityTypes;
            _this.doctorLists = data.doctorList;
        });
        return _this;
    }
    BookAppointmentComponent.prototype.ngOnInit = function () {
        ...
        this._route.queryParamMap.subscribe(function (queryParams) {
            var specialityType = queryParams.get("type");
            if (specialityType && specialityType === _core_model_doctor_list__WEBPACK_IMPORTED_MODULE_1__["COUNSELLOR"]) {
                _this.isCounsellor = true;
                _this.appointmentForm.controls.specialityType.setValue(_core_model_doctor_list__WEBPACK_IMPORTED_MODULE_1__["COUNSELLOR"]);
            }
            else {
                _this.isCounsellor = false;
                _this.appointmentForm.controls.specialityType.setValue('');
            }
            _this.specialistChanged();
        });
    };
    BookAppointmentComponent.prototype.save = function () {
        var _this = this;
        ...
        this._api.bookAppointment(payload).subscribe(function () {
            _this.error = false;
            _this._session.setState(_core_services_session_service__WEBPACK_IMPORTED_MODULE_3__["SESSION_KEY"].DOCTOR_LIST, {
                newAppointmentBanner: true
            });
            _this._session.setState(_core_services_session_service__WEBPACK_IMPORTED_MODULE_3__["SESSION_KEY"].USER, {
                appointmentDetails: [lodash__WEBPACK_IMPORTED_MODULE_8__["pick"](payload, ['appointmentID', 'appointmentDate', 'appointmentTime'])]
            }, true);
            _this._router.navigate(['/appointments/my-appointments']);
        }, function () {
            _this.error = true;
        });
    };
    Object.defineProperty(BookAppointmentComponent.prototype, "doctorTimeSlot", {
        get: function () {
    ...
    BookAppointmentComponent.prototype.formatDate = function (date) {
        return ('0' + date.month).slice(-2) + "/" + ('0' + date.day).slice(-2) + "/" + date.year;
    };
    Object.defineProperty(BookAppointmentComponent.prototype, "availableTimeSlot", {
        get: function () {
            var _this = this;
            var selectedDate = this.appointmentForm.value.appointmentDate;
            if (!lodash__WEBPACK_IMPORTED_MODULE_8__["isEmpty"](this.doctorTimeSlot) && !lodash__WEBPACK_IMPORTED_MODULE_8__["isEmpty"](selectedDate) && lodash__WEBPACK_IMPORTED_MODULE_8__["has"](this.doctorTimeSlot, this.formatDate(selectedDate))) {
                var availableTimeSlot_1 = lodash__WEBPACK_IMPORTED_MODULE_8__["filter"](_core_model_doctor_list__WEBPACK_IMPORTED_MODULE_1__["TIME_SLOTS"], function (eachSlot) {
                    return lodash__WEBPACK_IMPORTED_MODULE_8__["find"](_this.doctorTimeSlot[_this.formatDate(selectedDate)], function (bookedSlot) { return bookedSlot.timeSlot === eachSlot; });
                });
                return lodash__WEBPACK_IMPORTED_MODULE_8__["omitBy"](this.timeSlots, function (eachSlot) { return lodash__WEBPACK_IMPORTED_MODULE_8__["includes"](availableTimeSlot_1, eachSlot); });
            }
    ...
    BookAppointmentComponent.prototype.ngOnDestroy = function () {
        this._sessionSub$.unsubscribe();
    };
    Object.defineProperty(BookAppointmentComponent.prototype, "currentDoctorList", {
        get: function () {
    ...
    BookAppointmentComponent.prototype.specialistChanged = function () {
        var specialityType = this.appointmentForm.value.specialityType;
    ...
    Object.defineProperty(BookAppointmentComponent.prototype, "isDateEnabled", {
        get: function () {
    ...
    BookAppointmentComponent.prototype.doctorChanged = function () {
        var _this = this;
        this._api.getTimeSlots(this.appointmentForm.value.specialityType, this.appointmentForm.value.doctorID).subscribe(function (appointments) {
            _this.bookedTimeSlots[_this.appointmentForm.value.doctorID] = lodash__WEBPACK_IMPORTED_MODULE_8__["groupBy"](appointments, 'appointmentDate');
            console.log(_this.bookedTimeSlots);
        }, function (err) {
            console.log(err);
        });
    };
...
}(_core_components_base_component__WEBPACK_IMPORTED_MODULE_5__["BaseComponent"]));
...
var MyAppointmentsComponent = /** @class */ (function () {
    function MyAppointmentsComponent(_session) {
        var _this = this;
        this._session = _session;
        ...
        this._sessionSub$ = this._session.select(_core_services_session_service__WEBPACK_IMPORTED_MODULE_1__["SESSION_KEY"].USER).subscribe(function (data) {
            _this.appointmentDetails = _this._groupAppointments(data.appointmentDetails);
        });
    }
    MyAppointmentsComponent.prototype._groupAppointments = function (appointmentDetails) {
        var appointmentGroups = [];
        this._sevenDates.forEach(function (val) {
    ...
    Object.defineProperty(MyAppointmentsComponent.prototype, "todaysAppointmentCount", {
        get: function () {
    ...
    Object.defineProperty(MyAppointmentsComponent.prototype, "_sevenDates", {
        get: function () {
    ...
    MyAppointmentsComponent.prototype.ngOnDestroy = function () {
        this._sessionSub$.unsubscribe();
    };
    MyAppointmentsComponent.ctorParameters = function () { return [
        { type: _core_services_session_service__WEBPACK_IMPORTED_MODULE_1__["SessionService"] }
    ]; };
...
//# sourceMappingURL=modules-featured-appointments-appointments-module-es5.js.map